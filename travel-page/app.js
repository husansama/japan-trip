...
const DAILY_POSTERS = [
  ...
  ["day2-osaka-city-outfit.png", "Day 2 · 大阪市区慢游", "大阪城 → 中崎町 → 梅田 → 道顿堀"],
...
function renderReview() {
  ...
  const repetitions = [["城堡", "大阪城 vs 姬路城", "大阪城只保留外观与御座船；姬路城作为唯一正式入内城堡。"], ["游船", "大阪城御座船 vs 道顿堀夜船", "普通三选一保留价值更高的御座船；道顿堀夜船为¥900自费备选，按当晚体力决定。"], ["京都寺社／庭园", "好古园、天龙寺、金阁寺、平等院", "龙安寺已删除；Day4时间紧时再删除好古园，避免庭园审美疲劳。"], ["神社", "八坂、伏见稻荷、春日、明治", "八坂短停、伏见和明治保留；春日按Day8体力决定。"], ["老街", "中崎町、二年坂、祇园、奈良町", "东山是主角；祇园快走，奈良町与春日二选一。"], ["高空夜景", "东京铁塔地面拍摄 vs 涩谷SKY", "一个是地标合照、一个是城市俯瞰，视角不同且分两天安排，不算重复。"], ["任天堂", "USJ超级任天堂世界 vs 任天堂博物馆", "不重复：前者是游乐园互动，后者是历史展与室内互动，两个都保留。"]];
