...
function renderReview() {
  ...
  const days = [
    ...
    ["Day9 · 转东京＋东京铁塔", "4.2", "新桥御成门住宿将东京铁塔夜景压缩进步行圈；换城日仍保留充分休息。"],
  ...
  const groups = [
    ...
    ["Day9－Day10", [["增上寺＋芝公园／东京铁塔", "4.6／5.0／2.0／4.8", "低", "新桥御成门步行可达，日落后拍完即回新桥"], ["teamLab Borderless（可选）", "4.7／4.8／5.0／4.6", "低", "仅提前订到合适时段时加入；不订也不影响主线"], ["明治神宫", "4.3／4.3／2.5／4.5", "与京都神社不同", "保留森林都市感"], ["原宿＋表参道", "4.3／4.8／3.5／4.5", "与梅田、心斋桥同属购物", "风格不同，保留"], ["涩谷十字路口＋PARCO", "4.5／4.8／4.2／4.4", "低", "东京都市体验核心"], ["涩谷SKY", "4.5／5.0／3.0／3.8", "唯一高空项目", "已列为必去；恐高可优先停留室内楼层"]]],
  ];
